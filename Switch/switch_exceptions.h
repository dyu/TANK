...
struct exception : public std::exception
{
    ...
    exception(const exception &o) : b(o.b)
    {
    }

    exception(exception &&o) : b(std::move(o.b))
    {
    }
...
struct recoverable_error : public std::exception
{
    Buffer b;
    ...
    recoverable_error(const recoverable_error &o) : b(o.b)
    {
    }

    recoverable_error(recoverable_error &&o) : b(std::move(o.b))
    {
    }
