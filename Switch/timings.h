...
struct Seconds : public Unit<1000000000ULL>
{
};

struct Milliseconds : public Unit<1000000UL>
{
};

struct Microseconds : public Unit<1000>
{
};

struct Nanoseconds : public Unit<1>
{
};

struct Minutes : public Unit<1000000000ULL * 60>
{
};

struct Hours : public Unit<1000000000ULL * 60 * 60>
{
};

struct Days : public Unit<1000000000ULL * 60 * 60 * 24>
{
};

struct Weeks : public Unit<1000000000ULL * 60 * 60 * 24 * 7>
{
};
